...
You will see the QR code display on the EchoKit screen. If not, press and hold the **K0 button**, and then restart the device. You can restart the device by reconnecting the USB power or pressing the **RST button**.
