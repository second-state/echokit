...
Many of our customers have already received their **EchoKit**, ready to explore the fascinating world of **voice AI**. To help you become a **Voice AI agent master**, we’re kicking off the **First 30 Days with EchoKit** journey, which works for both [**EchoKit DIY**](https://echokit.dev/echokit_diy.html) and [**EchoKit Box**](https://echokit.dev/echokit_box.html) users.
...
> Wondering about Day 0? If you have a **DIY EchoKit**, [assemble it first](https://echokit.dev/docs/hardware/assemble-echokit).
...
1. Open a web browser (Chrome is recommended) on your desktop and go to:
